...
# ეს სკრიპტი ავტომატურად აშვებს მთელ სისტემას Docker-ში
...
try {
    ...
    Write-Host "⚠️  Migration warning (this might be OK if database already exists)" -ForegroundColor Yellow
}
